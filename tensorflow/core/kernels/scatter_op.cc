...
#define REGISTER_SCATTER_ARITHMETIC_SYCL_SPEC(type, dev)   \
...
#define REGISTER_SCATTER_ARITHMETIC_SYCL(type) \
  REGISTER_SCATTER_ARITHMETIC_SYCL_SPEC(type, SYCL);
...
#define REGISTER_SCATTER_MINMAX_SYCL(type) \
  REGISTER_SCATTER_MINMAX_SYCL_SPEC(type, SYCL);

TF_CALL_SYCL_NUMBER_TYPES(REGISTER_SCATTER_ARITHMETIC_SYCL);
TF_CALL_SYCL_NUMBER_TYPES(REGISTER_SCATTER_MINMAX_SYCL);
...
#undef REGISTER_SCATTER_MINMAX_SYCL_SPEC
#undef REGISTER_SCATTER_UPDATE_SYCL
#undef REGISTER_SCATTER_UPDATE_SYCL_SPEC

#undef REGISTER_SCATTER_ARITHMETIC_SYCL_SPEC
