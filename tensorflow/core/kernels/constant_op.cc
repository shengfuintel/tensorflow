...
TF_CALL_uint32(REGISTER_SYCL);
TF_CALL_uint64(REGISTER_SYCL);
TF_CALL_int8(REGISTER_SYCL);
TF_CALL_int16(REGISTER_SYCL);
TF_CALL_int64(REGISTER_SYCL);
TF_CALL_bool(REGISTER_SYCL);
TF_CALL_qint8(REGISTER_SYCL);
TF_CALL_qint16(REGISTER_SYCL);
TF_CALL_qint32(REGISTER_SYCL);
TF_CALL_quint16(REGISTER_SYCL);
TF_CALL_variant(REGISTER_SYCL);
