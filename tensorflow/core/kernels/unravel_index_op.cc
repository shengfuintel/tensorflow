 ...
 public:
  ...
  void Compute(OpKernelContext* ctx) override {
    ...
    if (TensorShapeUtils::IsScalar(indices_tensor.shape())) {
      ...
      Eigen::DSizes<int64, 2> reshape(dims_tensor.NumElements(), 1);
      Eigen::DSizes<int64, 2> bcast(1, indices_tensor.NumElements());
      Eigen::DSizes<int64, 2> indices_reshape(1, indices_tensor.NumElements());
      Eigen::DSizes<int64, 2> indices_bcast(dims_tensor.NumElements(), 1);
